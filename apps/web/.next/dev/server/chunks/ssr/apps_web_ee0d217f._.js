...
"[project]/apps/web/hooks/useLicenseInventory.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
filters) {
    ...
    const [errorMessage, setErrorMessage] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"](undefined);
    // (optional) ให้ options เป็น tuple literal จะ strict ขึ้น
    const statusOptions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>[
            "Active",
            "Expired",
            "Expiring"
        ], []);
    const licenseModelOptions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>[
            "Per-User",
            "Per-Device",
            "Subscription",
            "Perpetual"
        ], []);
    const manufacturerOptions = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>[
            "Microsoft",
            "Adobe",
            "Autodesk"
        ], []);
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"](()=>{
        ...
        (async ()=>{
            try {
                ...
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$licenses$2e$service$2e$mock$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLicenses"])({
                    //   service ใช้ 1-based
...
"[project]/apps/web/lib/tables/licenseInventoryColumns.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const licenseColumns = [
    {
        ...
        width: 220,
        cell: (v, row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
    ...
    },
    {
        ...
        width: 140,
        cell: (v)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$date$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDateTH"])(typeof v === "string" ? v : undefined)
    },
    {
        id: "status",
        header: "Status",
...
"[project]/apps/web/lib/mappers/licenseFilterMappers.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toSimpleFilters(df) {
    return {
        status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(df.status),
        type: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(df.licenseModel),
        manufacturer: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(df.manufacturer),
        search: df.search ?? ""
    };
}
function toDomainFilters(sf) {
    if (!sf) return {};
    return {
        status: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(sf.status),
        licenseModel: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(sf.type),
        manufacturer: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUndef"])(sf.manufacturer),
        search: sf.search ?? ""
    };
}
...
"[project]/apps/web/lib/summary.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/app/(app)/software/license-management/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useLicenseInventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/hooks/useLicenseInventory.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$licenseInventoryColumns$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/tables/licenseInventoryColumns.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$licenseFilterMappers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/mappers/licenseFilterMappers.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$summary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/summary.ts [app-ssr] (ecmascript)");
...
function LicenseManagementPage() {
    const [domainFilters, setDomainFilters] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$licenseFilterMappers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toDomainFilters"])());
    const ctl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useServerTableController$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useServerTableController"])({
        ...
        domainFilters,
        setDomainFilters,
        toSimple: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$licenseFilterMappers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSimpleFilters"])(domainFilters),
        fromSimple: (sf)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$licenseFilterMappers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toDomainFilters"])(sf),
        resetDeps: [
    ...
    const serviceFilters = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$licenseFilterMappers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toServiceFilters"])(ctl.simpleFilters), [
        ctl.simpleFilters
    ]);
    const { rows, totalRows, isLoading, isError, errorMessage, statusOptions, licenseModelOptions, manufacturerOptions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useLicenseInventory$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLicenseInventory"])(ctl.serverQuery, serviceFilters);
    // 🔹 Summary ทั้งระบบ (ไม่ผูก paging) รองรับฟิลเตอร์
    const { summary, isLoading: isLoadingSummary } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useLicenseSummary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLicenseSummary"])({
    ...
    // 🔹 แปลง summary → การ์ด
    const summaryCards = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"](()=>isLoadingSummary ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$summary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildLicenseSummarySkeleton"])() : (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$summary$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildLicenseSummaryCards"])(summary), [
        isLoadingSummary,
        summary
    ]);
    const [selectedLicenseIds, setSelectedLicenseIds] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"]([]);
    const getRowHref = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"]((row)=>`/software/license-management/${row.id}`, []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$inventory$2f$InventoryPageShell$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InventoryPageShell"], {
        ...
        hasType: true,
        // DataTable
        columns: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$licenseInventoryColumns$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["licenseColumns"],
        rows: rows,
        totalRows: totalRows,
...
//# sourceMappingURL=apps_web_ee0d217f._.js.map