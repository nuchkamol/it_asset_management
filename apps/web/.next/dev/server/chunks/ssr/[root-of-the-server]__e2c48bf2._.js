...
"[project]/apps/web/app/api/auth/[...nextauth].ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                console.log("CREDENTIALS FROM CLIENT:", credentials);
                const email = credentials?.email;
                if (!email) {
                    console.log("❌ No email received in authorize()");
                    return null;
                }
                return {
                    id: "mock-" + Date.now(),
...
// ✅ รูปแบบที่ถูกต้องสำหรับ App Router
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/api/auth/[...nextauth].ts [app-rsc] (ecmascript)");
;
;
;
;
...
async function AppRootLayout({ children }) {
    // ⬇️ ดึง session (v4)
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$next$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["authOptions"]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2c48bf2._.js.map