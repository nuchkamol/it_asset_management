...
"[project]/apps/web/services/devices.service.mock.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAllDevicesQuick(signal) {
 ...
 // }
var _c, _c1;
__turbopack_context__.k.register(_c, "MOCK_DEVICES$Array.from({ length: 57 }).map");
__turbopack_context__.k.register(_c1, "MOCK_DEVICES");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/hooks/useDeviceInventory.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$devices$2e$service$2e$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/services/devices.service.mock.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
function useDeviceInventory(serverQuery, filters = {}) {
    ...
    const q = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "useDeviceInventory.useMemo[q]": ()=>{
            ...
            return {
                ...
                deviceGroup: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.deviceGroup),
                deviceType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.deviceType),
                os: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.os)
            };
        }
    }["useDeviceInventory.useMemo[q]"], [
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useDeviceInventory.useEffect": ()=>{
            const ac = new AbortController();
            let alive = true;
            ({
                "useDeviceInventory.useEffect": async ()=>{
                    try {
                        setLoading(true);
                        setError(false);
                        setErrorMessage(undefined);
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$devices$2e$service$2e$mock$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDevices"])(q, ac.signal);
                        if (!alive) return;
...
_s(useDeviceInventory, "sWebtYTgPQ7vD7kZMCunysspX2U=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/apps/web/lib/tables/deviceInventoryColumns.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/lib/mappers/deviceFilterMappers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toDomainFilters(sf) {
    if (!sf) return {};
    return {
        deviceGroup: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndef"])(sf.status),
        deviceType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndef"])(sf.type),
        os: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndef"])(sf.manufacturer),
        search: sf.search ?? ""
    };
}
...
"[project]/apps/web/app/(app)/devices/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useDeviceInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/hooks/useDeviceInventory.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$deviceInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/tables/deviceInventoryColumns.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$deviceFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/mappers/deviceFilterMappers.ts [app-client] (ecmascript)");
...
function DevicesPage() {
   ...
   * ------------------------------------------------------- */ const [domainFilters, setDomainFilters] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$deviceFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"])());
    const ctl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useServerTableController$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerTableController"])({
        ...
        setDomainFilters,
        toSimple: {
            "DevicesPage.useServerTableController[ctl]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$deviceFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toSimpleFilters"])(domainFilters)
        }["DevicesPage.useServerTableController[ctl]"],
        fromSimple: {
            "DevicesPage.useServerTableController[ctl]": (sf)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$deviceFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"])(sf)
        }["DevicesPage.useServerTableController[ctl]"],
        resetDeps: [
    ...
    const serviceFilters = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "DevicesPage.useMemo[serviceFilters]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$deviceFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toServiceFilters"])(ctl.simpleFilters)
    }["DevicesPage.useMemo[serviceFilters]"], [
        ctl.simpleFilters
    ]);
    const { rows, totalRows, isLoading, isError, errorMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useDeviceInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceInventory"])(ctl.serverQuery, domainFilters);
    /* -------------------------------------------------------
   *  OPTIONS
   ...
   * ------------------------------------------------------- */ const [selectedDeviceIds, setSelectedDeviceIds] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]([]);
   ...
   * ------------------------------------------------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$inventory$2f$InventoryPageShell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryPageShell"], {
        ...
        hasType: true,
        // DataTable
        columns: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$deviceInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deviceInventoryColumns"],
        rows: rows,
        totalRows: totalRows,
...
_s(DevicesPage, "OuNleau8BwHtPVpkuOfKxTnhH68=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useDeviceInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeviceInventory"]
    ];
});
_c = DevicesPage;
var _c;
...
//# sourceMappingURL=apps_web_8c2d95b2._.js.map