...
"[project]/apps/web/lib/demo/softwareDetailDemoData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const demoSoftwareInstallations = [
    {
        id: "sw-ins-1",
        deviceName: "NB-204",
        userName: "alice",
...
"[project]/apps/web/lib/mappers/mapSoftwareItemToForm.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "mapSoftwareItemToForm",
    ()=>mapSoftwareItemToForm
]);
function mapSoftwareItemToForm(item) {
    return {
...
"[project]/apps/web/lib/tables/softwareInstallationColumns.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "softwareInstallationColumns",
    ()=>softwareInstallationColumns
]);
...
const softwareInstallationColumns = [
    {
        id: "deviceName",
        header: "Device",
...
"[project]/apps/web/components/detail/SoftwareDetail.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$demo$2f$softwareDetailDemoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/demo/softwareDetailDemoData.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$mapSoftwareItemToForm$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/mappers/mapSoftwareItemToForm.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$softwareInstallationColumns$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/tables/softwareInstallationColumns.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/show.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$detail$2f$DetailInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/components/detail/DetailInfo.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$detail$2f$HistoryList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/components/detail/HistoryList.tsx [app-client] (ecmascript)");
...
;
;
function SoftwareDetail({ item, installations, history, breadcrumb, licenses }) {
    _s();
    const onBack = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "SoftwareDetail.useCallback[onBack]": ()=>window.history.back()
    }["SoftwareDetail.useCallback[onBack]"], []);
    const onDelete = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "SoftwareDetail.useCallback[onDelete]": ()=>{
    ...
    const rows = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SoftwareDetail.useMemo[rows]": ()=>installations?.length ? installations : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$demo$2f$softwareDetailDemoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["demoSoftwareInstallations"]
    }["SoftwareDetail.useMemo[rows]"], [
        installations
    ]);
    // Derive history data
    const historyData = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SoftwareDetail.useMemo[historyData]": ()=>history?.length ? history : __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$demo$2f$softwareDetailDemoData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["demoHistory"]
    }["SoftwareDetail.useMemo[historyData]"], [
        history
    ]);
    const initialValues = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SoftwareDetail.useMemo[initialValues]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$mapSoftwareItemToForm$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapSoftwareItemToForm"])(item)
    }["SoftwareDetail.useMemo[initialValues]"], [
        item
    ]);
    ...
    const toolbar = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$toolbar$2f$InventoryActionToolbar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryActionToolbar"], {
        ...
        fileName: "[project]/apps/web/components/detail/SoftwareDetail.tsx",
        lineNumber: 66,
        columnNumber: 5
    }, this);
    //   เตรียมแถวสำหรับแท็บ Licenses (ถ้าไม่มี ให้เป็นอาร์เรย์ว่าง)
    const licenseRows = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "SoftwareDetail.useMemo[licenseRows]": ()=>licenses && licenses.length ? licenses : []
    }["SoftwareDetail.useMemo[licenseRows]"], [
        licenses
    ]);
        ...
        tabs: [
            {
                ...
                content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$detail$2f$DetailInfo$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DetailInfoGrid"], {
                    left: [
                        ...
                        {
                            label: "Version",
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["show"])(item.version)
                        },
                        {
                            label: "License Type",
                        ...
                        },
                        {
                            ...
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["show"])(item.policyCompliance)
                        }
                    ],
                    right: [
                        {
                            label: "Category",
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["show"])(item.category)
                        },
                        {
                            label: "Expiry Date",
                        ...
                        {
                            label: "Client/Server",
                            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["show"])(item.clientServer)
                        }
                    ]
                }, void 0, false, {
                    fileName: "[project]/apps/web/components/detail/SoftwareDetail.tsx",
            ...
            },
            {
                ...
                content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$tabbar$2f$InstallationSection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InstallationSection"], {
                    rows: rows,
                    columns: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$softwareInstallationColumns$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["softwareInstallationColumns"],
...
_s(SoftwareDetail, "Naw9Q7lxHLeVhDtYXd4cLyL5G7Y=");
_c = SoftwareDetail;
var _c;
__turbopack_context__.k.register(_c, "SoftwareDetail");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_2dd2fc59._.js.map