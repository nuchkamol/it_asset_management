...
"[project]/apps/web/lib/tables/exceptionInventoryColumns.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const exceptionInventoryColumns = [
    ...
    },
    {
        ...
        cell: (value)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$ui$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StatusBadge"], {
                label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$show$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["show"])(value),
                variant: "exception"
            }, void 0, false, {
...
"[project]/apps/web/lib/mappers/exceptionFilterMappers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/hooks/useExceptionInventory.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useExceptionInventory(serverQuery, filters = {}) {
    ...
    const serviceQuery = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "useExceptionInventory.useMemo[serviceQuery]": ()=>{
            const { pageIndex = 0, pageSize = 10, sortBy, sortOrder } = serverQuery;
            const search = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.search) ?? undefined;
            const status = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.status);
            return {
                page: pageIndex + 1,
                pageSize,
                sortBy: sortBy,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useExceptionInventory.useEffect": ()=>{
            const ac = new AbortController();
            let alive = true;
            ({
                "useExceptionInventory.useEffect": async ()=>{
                    try {
                        setLoading(true);
                        setError(false);
                        setErrorMessage(undefined);
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExceptionDefinitions"])(serviceQuery, ac.signal);
                        if (!alive) return;
...
_s(useExceptionInventory, "i23uOg7CIjFrCcRcXtx81OrEYFw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/app/(app)/exceptions/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$exceptionInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/tables/exceptionInventoryColumns.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$exceptionFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/mappers/exceptionFilterMappers.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useExceptionInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/hooks/useExceptionInventory.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function ExceptionPage() {
    ...
    const [domainFilters, setDomainFilters] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$exceptionFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"])());
    // Controller
    const ctl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useServerTableController$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerTableController"])({
        ...
        domainFilters,
        setDomainFilters,
        toSimple: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$exceptionFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toSimpleFilters"],
        fromSimple: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$exceptionFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"],
        resetDeps: [
    ...
    const serviceFilters = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "ExceptionPage.useMemo[serviceFilters]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$exceptionFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toServiceFilters"])(ctl.simpleFilters)
    }["ExceptionPage.useMemo[serviceFilters]"], [
        ctl.simpleFilters
    ]);
    // ดึงข้อมูลในตาราง (ให้ hook คืน rows: ExceptionDefinitionRow[])
    const { rows, totalRows, isLoading, isError, errorMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useExceptionInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useExceptionInventory"])(ctl.serverQuery, serviceFilters);
    // ตัวเลือกสถานะ
    const statusOptions = [
        "Active",
        "Inactive"
    ];
    const [selectedIds, setSelectedIds] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]([]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$inventory$2f$InventoryPageShell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InventoryPageShell"], {
        ...
        // {/* DataTable */}
        columns: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$exceptionInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exceptionInventoryColumns"],
        rows: rows,
        totalRows: totalRows,
...
_s(ExceptionPage, "swKr4IOTcEDxx6phteTTL2RQIjw=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useExceptionInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useExceptionInventory"]
    ];
});
_c = ExceptionPage;
var _c;
__turbopack_context__.k.register(_c, "ExceptionPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_a8fe8f3b._.js.map