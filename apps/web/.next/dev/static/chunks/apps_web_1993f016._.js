...
"[project]/apps/web/lib/name.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/lib/tables/employeeInventoryColumns.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$name$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/name.ts [app-client] (ecmascript)"); // ← มีอยู่แล้วใน lib ของคุณ
;
;
;
const employeeColumns = [
    ...
    // ---------- Employee Name (ต่อ first + last ใน cell) ----------
    {
        ...
        cell: (_value, row)=>{
            const e = row;
            const display = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$name$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fullNameTh"])(e);
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
"[project]/apps/web/lib/mappers/employeeFilterMappers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const normStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeByMap"])({
    Active: "Active",
    Inactive: "Inactive",
...
"[project]/apps/web/config/config.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SERVER_API_BASE = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.API_BASE ?? ("TURBOPACK compile-time value", "http://localhost:8000") ?? '';
if (!SERVER_API_BASE) {
...
"[project]/apps/web/lib/http.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/web/services/exceptions.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/config/config.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/http.ts [app-client] (ecmascript)");
;
;
...
async function getExceptionDefinitionById(id, signal) {
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/exceptions/${encodeURIComponent(String(id))}`);
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"])(url, {
        method: "GET",
        signal
    });
...
async function getExceptionDefinitions(q, signal) {
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/exceptions${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["qs"])(query)}`);
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"])(url, {
        method: "GET",
        signal
    });
...
async function assignExceptionsToEmployees(exceptionId, empCodes, assignedBy, signal) {
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/exceptions/${encodeURIComponent(String(exceptionId))}/assign`);
...
async function unassignExceptionsFromEmployees(exceptionId, empCodes, opts, signal) {
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/exceptions/${encodeURIComponent(String(exceptionId))}/revoke`);
    const body = JSON.stringify({
        empCodes,
...
async function getExceptionAssigneesPage(exceptionId, q, signal) {
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/exceptions/${encodeURIComponent(String(exceptionId))}/assignees${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["qs"])(query)}`);
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"])(url, {
        method: "GET",
        signal
    });
...
"[project]/apps/web/hooks/useActiveExceptionDefinitions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/services/exceptions.service.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
;
function useActiveExceptionDefinitions() {
    _s();
    const [defs, setDefs] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([]);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "useActiveExceptionDefinitions.useEffect": ()=>{
            const ac = new AbortController();
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getActiveExceptionDefinitions"])(ac.signal).then({
                "useActiveExceptionDefinitions.useEffect": (list)=>setDefs(list)
            }["useActiveExceptionDefinitions.useEffect"]).catch({
                "useActiveExceptionDefinitions.useEffect": (e)=>{
                    if (e?.name !== "AbortError") console.error(e);
                }
            }["useActiveExceptionDefinitions.useEffect"]).finally({
                "useActiveExceptionDefinitions.useEffect": ()=>setLoading(false)
            }["useActiveExceptionDefinitions.useEffect"]);
            return ({
                "useActiveExceptionDefinitions.useEffect": ()=>ac.abort()
            })["useActiveExceptionDefinitions.useEffect"];
        }
    }["useActiveExceptionDefinitions.useEffect"], []);
    return {
...
_s(useActiveExceptionDefinitions, "yZehFUE4OfTuGRNgEYj2QMtNZvY=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/services/employees.service.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function listEmployees(q, signal) {
    ...
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/employees${(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["qs"])(query)}`);
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"])(url, {
        method: "GET",
        signal
    });
...
async function getEmployeeById(id, signal) {
    const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$config$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildUrl"])(`/employees/${encodeURIComponent(id)}`);
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$http$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["http"])(url, {
        method: "GET",
        signal
    });
...
"[project]/apps/web/hooks/useEmployeeInventory.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$employees$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/services/employees.service.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/filters.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function useEmployeesInventory(serverQuery, filters = {}) {
    _s();
    const [rows, setRows] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]([]);
    const [totalRows, setTotalRows] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](0);
    const [isLoading, setLoading] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    const [isError, setError] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    const [errorMessage, setErrorMessage] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]();
    /**
   ...
   */ const serviceQuery = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "useEmployeesInventory.useMemo[serviceQuery]": ()=>{
            const { pageIndex = 0, pageSize = 10, sortBy, sortOrder } = serverQuery;
            const status = filters.status; // EmployeeStatus | undefined
            const type = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.type);
            const search = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$filters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toUndefTrim"])(filters.search) ?? "";
            //   จากหน้า Assign
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "useEmployeesInventory.useEffect": ()=>{
            const ac = new AbortController();
            let alive = true;
            ({
                "useEmployeesInventory.useEffect": async ()=>{
                    try {
                        setLoading(true);
                        setError(false);
                        setErrorMessage(undefined);
                        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$employees$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["listEmployees"])(serviceQuery, ac.signal);
                        if (!alive) return;
                        ...
                        if (isAllStatus && sortBy === "status_priority") {
                            ...
                            nextRows = stableSortByPriorityThen(nextRows, {
                                "useEmployeesInventory.useEffect": (r)=>r.status
                            }["useEmployeesInventory.useEffect"], PRIORITY, {
                                "useEmployeesInventory.useEffect": (r)=>r.id
                            }["useEmployeesInventory.useEffect"]);
                            if (sortOrder === "desc") {
                                nextRows = [
                                    ...nextRows
...
_s(useEmployeesInventory, "i23uOg7CIjFrCcRcXtx81OrEYFw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/apps/web/components/filters/EmployeeFilterBar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EmployeeFilterBar({ filters, onFiltersChange, statusOptions = [
    ...
    const fbFilters = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "EmployeeFilterBar.useMemo[fbFilters]": ()=>({
    ...
    const handleChange = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "EmployeeFilterBar.useCallback[handleChange]": (next)=>{
            onFiltersChange({
    ...
    }["EmployeeFilterBar.useCallback[handleChange]"], [
        onFiltersChange
    ]);
    // labels (default + merge)
    const mergedLabels = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "EmployeeFilterBar.useMemo[mergedLabels]": ()=>({
    ...
    const statusOptsAsString = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "EmployeeFilterBar.useMemo[statusOptsAsString]": ()=>statusOptions.map({
                "EmployeeFilterBar.useMemo[statusOptsAsString]": (s)=>s
            }["EmployeeFilterBar.useMemo[statusOptsAsString]"])
    }["EmployeeFilterBar.useMemo[statusOptsAsString]"], [
        statusOptions
    ]);
    const deptOptsAsString = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "EmployeeFilterBar.useMemo[deptOptsAsString]": ()=>departmentOptions.map({
                "EmployeeFilterBar.useMemo[deptOptsAsString]": (d)=>d
            }["EmployeeFilterBar.useMemo[deptOptsAsString]"])
    }["EmployeeFilterBar.useMemo[deptOptsAsString]"], [
        departmentOptions
    ]);
...
_s(EmployeeFilterBar, "HYD9yZezQ9lAWl/ZgwK8PN//RUY=");
_c = EmployeeFilterBar;
var _c;
__turbopack_context__.k.register(_c, "EmployeeFilterBar");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/apps/web/app/(app)/exceptions/[id]/assign/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$employeeInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/tables/employeeInventoryColumns.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$employeeFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/lib/mappers/employeeFilterMappers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useActiveExceptionDefinitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/hooks/useActiveExceptionDefinitions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/services/exceptions.service.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useEmployeeInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/hooks/useEmployeeInventory.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$filters$2f$EmployeeFilterBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/components/filters/EmployeeFilterBar.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
...
function AssignEmployeeExceptionsPage() {
    _s();
    /* ------------------------ รับ exceptionId จาก URL ------------------------ */ const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])(); // Next.js App Router
    // รองรับทั้ง /exceptions/[id]/assign และ /exceptions/[exceptionId]/assign
    const exceptionId = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "AssignEmployeeExceptionsPage.useMemo[exceptionId]": ()=>String(params?.id ?? params?.exceptionId ?? "")
    }["AssignEmployeeExceptionsPage.useMemo[exceptionId]"], [
        params
    ]);
    // แปลงเป็น number (หรือ null ถ้าไม่ใช่ตัวเลข)
    const exceptionIdNum = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "AssignEmployeeExceptionsPage.useMemo[exceptionIdNum]": ()=>{
    ...
    /* --------------------------- Controller & Data --------------------------- */ const [domainFilters, setDomainFilters] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$employeeFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"])());
    const ctl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useServerTableController$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerTableController"])({
        ...
        setDomainFilters,
        toSimple: {
            "AssignEmployeeExceptionsPage.useServerTableController[ctl]": (df)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$employeeFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toSimpleFilters"])(df)
        }["AssignEmployeeExceptionsPage.useServerTableController[ctl]"],
        fromSimple: {
            "AssignEmployeeExceptionsPage.useServerTableController[ctl]": (sf)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$mappers$2f$employeeFilterMappers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDomainFilters"])(sf)
        }["AssignEmployeeExceptionsPage.useServerTableController[ctl]"],
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "AssignEmployeeExceptionsPage.useEffect": ()=>{
            setDomainFilters({
                "AssignEmployeeExceptionsPage.useEffect": (prev)=>{
    ...
    const { rows, totalRows, isLoading, isError, errorMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useEmployeeInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmployeesInventory"])(ctl.serverQuery, domainFilters);
    /* ------------------------------ Selections ------------------------------ */ const [selectedEmployeeIds, setSelectedEmployeeIds] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]([]);
    const selectedIdSet = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "AssignEmployeeExceptionsPage.useMemo[selectedIdSet]": ()=>new Set(selectedEmployeeIds)
    }["AssignEmployeeExceptionsPage.useMemo[selectedIdSet]"], [
        selectedEmployeeIds
    ]);
    const handleSelectionChange = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "AssignEmployeeExceptionsPage.useCallback[handleSelectionChange]": (next)=>{
            setSelectedEmployeeIds(Array.from(next).map(String));
        }
    }["AssignEmployeeExceptionsPage.useCallback[handleSelectionChange]"], []);
    /* ----------------- Exception Definition ที่เลือกจาก URL ----------------- */ const { defs, isLoading: loadingDefs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useActiveExceptionDefinitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActiveExceptionDefinitions"])();
    const currentDef = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "AssignEmployeeExceptionsPage.useMemo[currentDef]": ()=>defs.find({
                "AssignEmployeeExceptionsPage.useMemo[currentDef]": (d)=>d.id === exceptionId
            }["AssignEmployeeExceptionsPage.useMemo[currentDef]"])
    }["AssignEmployeeExceptionsPage.useMemo[currentDef]"], [
        defs,
        exceptionId
    ]);
    //   ดึงชื่อจาก backend รายตัว (ไม่จำกัด Active) เพื่อใช้เป็นหัวข้อเสมอ
    const [titleName, setTitleName] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](null);
    const [loadingTitle, setLoadingTitle] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "AssignEmployeeExceptionsPage.useEffect": ()=>{
            if (!exceptionId) {
                setTitleName(null);
            ...
            ({
                "AssignEmployeeExceptionsPage.useEffect": async ()=>{
                    try {
                        const def = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExceptionDefinitionById"])(exceptionId, ac.signal);
            ...
            return ({
                "AssignEmployeeExceptionsPage.useEffect": ()=>ac.abort()
            })["AssignEmployeeExceptionsPage.useEffect"];
        }
    }["AssignEmployeeExceptionsPage.useEffect"], [
        exceptionId
    ]);
    /* --------------------------------- Form --------------------------------- */ const [effectiveDate, setEffectiveDate] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](new Date().toISOString().slice(0, 10));
    const [note, setNote] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"]("");
    const canSubmit = selectedEmployeeIds.length > 0 && !!exceptionId;
    /* -------------------------------- Submit -------------------------------- */ const [submitting, setSubmitting] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](false);
    const [lastMsg, setLastMsg] = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](null);
    const onAssign = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "AssignEmployeeExceptionsPage.useCallback[onAssign]": async ()=>{
            if (!canSubmit || !exceptionId || selectedEmployeeIds.length === 0) return;
            setSubmitting(true);
            setLastMsg(null);
            try {
                const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$services$2f$exceptions$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["assignExceptionsToEmployees"])(exceptionId, selectedEmployeeIds, undefined);
    ...
    }["AssignEmployeeExceptionsPage.useCallback[onAssign]"], [
        canSubmit,
        exceptionId,
        selectedEmployeeIds,
        ctl
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$filters$2f$EmployeeFilterBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    filters: ctl.simpleFilters,
                    onFiltersChange: ctl.onSimpleFiltersChange,
                    statusOptions: STATUS_OPTIONS,
                    departmentOptions: DEPARTMENT_OPTIONS,
                    rightExtra: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$components$2f$table$2f$DataTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataTable"], {
                    columns: __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$tables$2f$employeeInventoryColumns$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["employeeColumns"],
                    rows: rows,
                    totalRows: totalRows,
            ...
            lastMsg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AssignEmployeeExceptionsPage, "ixArOJt/SohKczjp00Dqczuzrfs=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useEmployeeInventory$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEmployeesInventory"],
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$hooks$2f$useActiveExceptionDefinitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActiveExceptionDefinitions"]
    ];
});
_c = AssignEmployeeExceptionsPage;
var _c;
__turbopack_context__.k.register(_c, "AssignEmployeeExceptionsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=apps_web_1993f016._.js.map